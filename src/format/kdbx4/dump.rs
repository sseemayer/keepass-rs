...
pub fn dump_kdbx4(db: &Database, db_key: &DatabaseKey, writer: &mut dyn Write) -> Result<(), SaveKdbx4Error> {
    ...
    #[allow(clippy::expect_used)] // inner random stream key length is generated by us
    ...
    #[allow(clippy::expect_used)] // inputs to cipher should always have correct length
...
impl KDBX4InnerHeader {
    fn dump(&self, header_attachments: &[Attachment], writer: &mut dyn Write) -> Result<(), std::io::Error> {
